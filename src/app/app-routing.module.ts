...
const routes: Routes = [
  ...
  {
    path: 'sliding-list',
    loadChildren: () => import('./pages/sliding-list/sliding-list.module').then( m => m.SlidingListPageModule)
  },
  {
    path: 'list-reorder',
  ...
  {
    path: 'slides-practica',
    loadChildren: () => import('./pages/slides-practica/slides-practica.module').then( m => m.SlidesPracticaPageModule)
  },
  {
    path: 'slides-efectos',
    loadChildren: () => import('./pages/slides-efectos/slides-efectos.module').then( m => m.SlidesEfectosPageModule)
  },
  {
    path: 'fab',
  ...
  {
    path: 'grid-item',
    loadChildren: () => import('./pages/grid-item/grid-item.module').then( m => m.GridItemPageModule)
  },
];
