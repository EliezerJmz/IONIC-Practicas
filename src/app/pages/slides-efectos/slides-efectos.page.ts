...
@Component({
  selector: 'app-slides-efectos',
  templateUrl: './slides-efectos.page.html',
  styleUrls: ['./slides-efectos.page.scss'],
})
export class SlidesEfectosPage implements OnInit {
  ...
  //*************************** Efecto cube**************************************/
  //solo llamamos a la opcion desde el ahtml
  slideCubo = {
    grabCursor: true,
    cubeEffect: {
      shadow: true,
  ...
  //para navegar tambien podemos usar el navController
  regresarMenu(){
